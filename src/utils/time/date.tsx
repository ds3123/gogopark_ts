...
export const get_Type_Dates = (  interval : string[] , holiday : string[]  ) =>{
    ...
    //
    //     holiday.forEach(function ( y) {
    //
    //         if( y['date'] === x ){
    //             holiday_Arr.push(x);
    //             delete interval[ interval.indexOf(x)]; // 刪除為國定假日
    //         }
    //
    //     });
    //
    ...
    //
    //     if( ( week === 1 || week === 2 || week === 3 || week === 4  ) && x !== undefined  ){  M_T_Arr.push(x)  }
    //     if( ( week === 5 || week === 6 || week === 0  )              && x !== undefined  ){  F_S_Arr.push(x)  }
    //
    // });
    //
