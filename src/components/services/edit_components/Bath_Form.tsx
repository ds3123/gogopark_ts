...
const Bath_Form : FC<Edit_Form_Type> = ({ register , errors , isDirty , isValid } ) => {
    ...
    return <>
                <b className="tag is-large is-success"> <i className="fas fa-bath"></i> &nbsp; 洗 澡 </b> <br/><br/>
                ...
                <div className="columns is-multiline is-mobile">
                   ...
                   <div className="column is-2-desktop">  <b className="tag is-light is-large"> 第三次洗澡  </b>  <br/> <span className="fDred"> ( 必要時 或 重洗 ) </span></div>
                   <div className="column is-10-desktop">
