...
const Update_Price = ( ) => {
    ...
    const service_prices             = data.service_prices ;             // 品種 5 種價格資料 ( 初次洗澡、單次、.... / for 寵物品種 )
    ...
    const onSubmit : SubmitHandler<IService_Price> = ( data : any ) => {
        ...
        */
        ...
        if( source_Create_Way === '寵物品種' ){
            ...
            // 重組 _ 欲更新的 id 與 欄位
            const obj_First_Bath    = { id : first_Bath['id']  ,   obj : { service_price : data['price_Fist_Bath']   } } ;
            const obj_Single_Bath   = { id : single_Bath['id'] ,   obj : { service_price : data['price_Single_Bath'] } } ;
            const obj_Month_Bath    = { id : month_Bath['id']  ,   obj : { service_price : data['price_Month_Bath']  } } ;

            const obj_Single_Beauty = { id : single_Beauty['id'] , obj : { service_price : data['price_Single_Beauty'] } } ;
            const obj_Month_Beauty  = { id : month_Beauty['id']  , obj : { service_price : data['price_Month_Beauty'] } } ;
